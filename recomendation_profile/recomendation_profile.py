...
import pandas as pd
from functions import predict_1_user,model_df_for_user_wo_w2v,normalise_score
...
def recomendation_profile_predict(id_name,write_msg,avg_score):
    ...
    if os.path.exists(path_user):
        ...
        write_msg(id_name,'Подожди пожалуйста, собираем информацию...') 
...
def recomendation_score_2_users(id_name,id_target,avg_score,user_score_2_users):
    try:
        path_score_2_users = path_to_save + '\\score_2_users.pkl'
        path_avg_score=path_to_save + '\\avg_score.pkl'
        path_user = path_to_save + '\\' + str(id_name) + '.pkl'
